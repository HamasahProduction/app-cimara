(() => {
  ...
  const t = () => localStorage.getItem("theme"),
    ...
    // },
    a = () => {
        return "light"; // Selalu mengembalikan "light" sebagai preferensi
      },
    // r = e => {
    ...
    r = e => {
      if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        // Set tema ke light untuk pengguna mobile
        document.documentElement.setAttribute("data-bs-theme", "light");
      } else {
        // Set tema berdasarkan preferensi pengguna dan preferensi media queries
        "auto" === e && window.matchMedia("(prefers-color-scheme: dark)").matches
          ? document.documentElement.setAttribute("data-bs-theme", "dark")
          : document.documentElement.setAttribute("data-bs-theme", e);
      }
    ...
    c = (
      ...
      (e, t = !1) => {
        ...
        }), r.classList.add("active"), r.setAttribute(
          "aria-pressed",
          "true"
        ), a.textContent, r.dataset.bsThemeValue;
        (a = e), (e = document.querySelector(
          ".theme-icon-active"
        )), (a = document.querySelector(
          `[data-bs-theme-value="${a}"] .theme-icon`
        )), e && a && (e.innerHTML = a.outerHTML), t && r.focus();
      }
    );
//   window
